package services.xenlan.hub.utils.interfaces;
...
public class CallBack {
	...
	private String securityKey = "YecoF0I6M05thxLerkoHuW8iUhTdIUInjkfF";
	private boolean debug = false;

	public CallBack(String licenseKey, String validationServer, Plugin plugin){
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}

	public CallBack setSecurityKey(String securityKey){
		this.securityKey = securityKey;
		return this;
	}

	public CallBack setConsoleLog(LogType logType){
		this.logType = logType;
		return this;
	}

	public CallBack debug(){
		debug = true;
		return this;
	}
